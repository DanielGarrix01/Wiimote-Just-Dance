...
# IDs típicos del Wiimote
WIIMOTE_VENDOR_ID = 0x057E
WIIMOTE_PRODUCT_IDS = [0x0306, 0x0307]  # 0306: Wiimote, 0307: Wii Motion Plus

class Wiimote:
    _REPORT_SIZE = 22       # Tamaño típico de input report del Wiimote
    _UPDATE_PERIOD = 0.01   # Intervalo de actualización (10 ms)
    ...
    # -------------------------------
    # Hooks para recibir actualizaciones
    # -------------------------------
...
if __name__ == "__main__":
    ...
    wm.register_update_hook(print_status)
